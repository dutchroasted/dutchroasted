const plans = [
  ...
  },
  {
    ...
    description: "Voor wie vaker outfitfeedback wil en zijn stijl wil opbouwen.",
    features: [
      "Onbeperkt outfit checks",
      "Outfit geschiedenis",
      "Persoonlijk stijlprofiel",
      "Betere shop suggesties",
      "Downloadbare style reports",
    ],
