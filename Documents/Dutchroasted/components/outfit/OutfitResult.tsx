...
function SharePreviewCard({
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.16),rgba(0,0,0,0.18)_36%,rgba(0,0,0,0.86))]" />
      <div className="relative flex h-full flex-col justify-between p-5 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm font-bold text-zinc-300">AI outfit verdict</p>
          </div>
          <div className="rounded-2xl bg-orange-500 px-4 py-3 text-right text-black shadow-[0_18px_60px_rgba(255,106,0,0.28)]">
            <p className="text-xs font-black uppercase tracking-[0.14em]">Score</p>
            <p className="text-3xl font-black">{result.score}/10</p>
          </div>
        </div>

        <div>
          <p className="inline-flex rounded-full border border-orange-500/40 bg-orange-500/20 px-3 py-1 text-xs font-black uppercase tracking-[0.14em] text-orange-100 backdrop-blur">
            {verdict}
          </p>
          <div className="mt-4 rounded-3xl border border-white/15 bg-black/58 p-5 backdrop-blur-md">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-orange-300">
              🔥 Roast
            </p>
            <p className="mt-3 text-2xl font-black leading-8 text-white sm:text-3xl sm:leading-10">
              “{result.roast}”
            </p>
          </div>
          <p className="mt-5 text-sm font-black text-zinc-200">DutchRoasted.nl</p>
        </div>
      </div>
    </div>
  );
