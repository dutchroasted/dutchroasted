...
export const seoV2Pages = [
  ...
  page({
    ...
    relatedSlugs: ["outfit-checker", "ai-outfit-checker", "kledingstijl-check", "premium-outfit-analyse"],
  }),
  page({
    slug: "ai-stylist",
    ...
    relatedSlugs: ["fashion-ai", "premium-outfit-analyse", "kledingstijl-check", "outfit-beoordelen"],
  }),
  page({
    slug: "outfit-roast",
  ...
  page({
    ...
    relatedSlugs: ["ai-stylist", "ai-outfit-checker", "premium-outfit-analyse", "outfit-score"],
  }),
  page({
    slug: "outfit-score",
